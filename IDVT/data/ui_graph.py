...
class Interaction(Data,Graph):
    ...
    def __generate_set(self):
        ...
        for entry in self.test_data:
            ...
            if user not in self.user or item not in self.item:
                continue
            # ciao:41534  total: 56380   
            # Yelp:31194  total: 31274 

            #flickr:35719 total:35761
            #yelp:24386   total:24473
            #ciao:27207   total:27302
            num=num+1
    ...
    def test_size(self):
        ...
        #return len(self.test_set), len(self.test_set_item), len(self.test_set)
